...
class Pet(db.Model):
    ...
    @classmethod
    def find_pets_of_same_category(cls, name: str):
        """Returns all items of same category as category of item name
        
        Keyword arguments:
        :param name: the name of the Pets you want to match
        :type name: str

        :return: a collection of Pets with the category same as the category of item name
        :rtype: list
        """
